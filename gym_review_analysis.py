...
class GymReviewAnalyzer:
    ...
    def load_data(self, google_url=None, trustpilot_url=None):
        """
        Load review data from Google Sheets or local files.
        ...
        if google_url and trustpilot_url:
            # Load from URLs (original functionality)
        ...
        print(f"Loaded {len(self.goog_reviews)} Google reviews")
        print(f"Loaded {len(self.tp_reviews)} Trustpilot reviews")
